...
class Epick_double
  : public Filtered_kernel_adaptor<
               Type_equality_wrapper< Simple_cartesian<NT>::Base<Epick_double>::Type, Epick_double >,
...
//               Type_equality_wrapper< Simple_cartesian<double>::Base<Epick>::Type, Epick_double >,

typedef Epick_double Exact_predicates_inexact_constructions_kernel_double;

template <>
struct Triangulation_structural_filtering_traits<Epick_double> {
