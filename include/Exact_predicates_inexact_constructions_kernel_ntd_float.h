...
class Epick_float
  : public Filtered_kernel_adaptor<
               Type_equality_wrapper< Simple_cartesian<NT>::Base<Epick_float>::Type, Epick_float >,
...
//               Type_equality_wrapper< Simple_cartesian<double>::Base<Epick>::Type, Epick_float >,

typedef Epick_float Exact_predicates_inexact_constructions_kernel;

template <>
struct Triangulation_structural_filtering_traits<Epick_float> {
