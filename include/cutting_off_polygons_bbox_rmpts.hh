/*
 * cutting_off_polygons_bbox_rmpts.hh
 *
...
/*
 *  Cutting off the polygons along the interface line with the bounding box + remove close points
 */

#ifndef INCLUDE_CUTTING_OFF_POLYGONS_BBOX_RMPTS_HH_
#define INCLUDE_CUTTING_OFF_POLYGONS_BBOX_RMPTS_HH_
...
template <typename Kernel, typename Output_Child_Polys, typename IP_Ell, typename Output_IP, typename NT>
Output_Child_Polys cutting_off_polygons_bbox_rmpts(CGAL::Surface_mesh< CGAL::Point_3<Kernel> >  &polygon1,
...
#endif /* INCLUDE_CUTTING_OFF_POLYGONS_BBOX_RMPTS_HH_ */
