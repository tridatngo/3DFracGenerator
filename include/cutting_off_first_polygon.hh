/*
 * cutting_off_first_polygon.hh
 *
 *  Created on: Sep 16, 2016
 *      Author: ngotr
 */

#ifndef INCLUDE_CUTTING_OFF_FIRST_POLYGON_HH_
#define INCLUDE_CUTTING_OFF_FIRST_POLYGON_HH_
...
Output_Child_Polys cutting_off_first_polygon(std::list<Ell_> &ell_list, Ell_ &cEll_1, Ell_ cEll_2, double &target_edge_length){
	...
	if (intersection_points_1.size() + intersection_points_2.size() < 4){
		...
		std::list<Point_3> AddPoints2NewPoly_1_new,AddPoints2NewPoly_1_dummy, AddPoints2IntersectionLine;
		...
		if ( (*list_IP_Ell_output.begin()).Ell_name_ == (*(boost::next(list_IP_Ell_output.begin()))).Ell_name_ ){
			...
			/*
			 * TODO filesystem exist of the file containing intersection line information
...
#endif /* INCLUDE_CUTTING_OFF_FIRST_POLYGON_HH_ */
